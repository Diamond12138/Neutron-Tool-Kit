...
namespace ntk
{
    namespace Graphics
    {
        Texture::Texture(GLenum texture_type) : Bindable(), m_texture_type(texture_type) {}
        Texture::Texture(GLenum texture_type, GLuint textureID) : Bindable(textureID), m_texture_type(texture_type) {}
        ...
        GLenum Texture::get_texture_type() const
        {
        ...
        void Texture::bind()
        {
            glBindTexture(m_texture_type, m_objectID);
        }
